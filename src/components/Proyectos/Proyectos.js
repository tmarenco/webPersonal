...
function Proyectos() {
  return (
    <div>
      ...
      <GeneradorDeProyectos nombre="Mi web" descripcion="Sitio web personal con proyectos, datos e info." repositorio="https://github.com/tmarenco/webPersonal" image="/documents/miWeb.png" link="https://tomasmarenco.herokuapp.com/"/>
    </div>
  );
}
